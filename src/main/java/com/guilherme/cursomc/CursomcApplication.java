...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "4654111161", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("156485487", "45454564"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "13213123", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "378874524", cli1, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2017 22:15"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 17:06"), cli1, e2);
